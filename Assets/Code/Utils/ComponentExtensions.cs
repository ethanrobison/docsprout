...
namespace Code.Utils
{
    ...
    {
        public static T GetRequiredComponent<T> (this GameObject component)
            where T : Component {
        ...
        public static T[] GetRequiredComponents<T> (this GameObject component)
            where T : Component {
        ...
        public static T GetRequiredComponentInParent<T> (this GameObject component)
            where T : Component {
